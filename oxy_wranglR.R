...
#'     directory.
#'     
#' @param weir_open Character string representing the date the Canning Weir
#'     was opened (if appropriate), default: NULL
#'     
#' @param weir_closed Character string representing the date the Canning
#'     weir was closed (if appropriate), default: NULL
#'     
#' @return Three PNG Oxy KPI plots saved to `plots/` directory and a csv
#'     file of the current Oxy KPI stats.
#'     
#' @examples
#' \dontrun{
